...
SKIP_INFRA_LIB_MODULES=("bson" "kafka-manual-ack" "guice" "jersey" "jetty-filter" "jetty" "jooq" "jsonapi" "kafka-server" "kafka" "kryo" "lang" "logging" "maxwell" "mongo" "multistage" "parquet" "request" "rest" "secrets" "ssl" "syndicatedcache" "testing" "threads" "kafka-admin")
