...
SKIP_INFRA_LIB_MODULES=("bson" "kafka-manual-ack" "jooq" "logging" "maxwell" "mongo" "multistage" "parquet" "request" "rest" "secrets" "ssl" "syndicatedcache" "testing" "threads" "kafka-admin")
